...
import com.zay.crowd.entity.po.ProjectItemPicPO;
import com.zay.crowd.entity.po.ProjectItemPicPOExample;
...
public interface ProjectItemPicPOMapper {
	...
	void insertDetailPicturePathList(@Param("list")List<String> detailPicturePathList, @Param("id")Integer projectId);
}